...
Multi-query, self-query, compression, hybrid search with Google Gemini
"""
...
providers including Google Gemini, OpenAI, Anthropic, and local models like Llama.
...
TECH_DOCS = [
    ...
    Document(
        page_content="LangChain is a framework for building LLM applications. It provides tools for prompts, chains, agents, and memory. LangChain supports multiple LLM providers including Google Gemini, OpenAI, Anthropic, and local models.",
        metadata={
            "topic": "ai",
